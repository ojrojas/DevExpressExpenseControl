...
internal static class Extensions
{
    public static void AddApplicationServices(this IHostApplicationBuilder builder)
    {
        ...
        {
            options.SetDefaultCulture("es-CO")
        ...
        builder.AddSqlServerDbContext<IdentityAppDbContext>("identitydb", configureDbContextOptions: options =>
        {
            options.UseOpenIddict();
        });

        builder.EnrichSqlServerDbContext<IdentityAppDbContext>();
